...
/// A scrollable container that arranges children vertically (top-to-bottom).
///
/// This is equivalent to a `Vertical` container wrapped in a `ScrollableContainer`,
/// providing vertical scrolling when content exceeds the viewport height.
///
/// # Example
///
/// ```ignore
/// use textual::VerticalScroll;
///
/// ui! {
///     VerticalScroll {
///         Label("Item 1")
...
impl<M: 'static> Widget<M> for VerticalScroll<M> {
...
"#
    ...
    fn get_meta(&self) -> WidgetMeta {
        ...
        meta.type_name = "VerticalScroll".to_string();
        meta
    }
